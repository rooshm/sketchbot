...
def draw_lines(lines, resolution=1024, w=1024, h=1024):
...
def sketch(img, export_path=None, draw_contours=True, draw_hatch=True, show_bitmap=False, resolution=1024, hatch_size=16, contour_simplify=2):
